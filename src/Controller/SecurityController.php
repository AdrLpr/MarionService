...
use App\Form\Security\SignInType;
...
class SecurityController extends AbstractController
{
    ...
    #[Route(path:'/singIn', name:'app_signIn')]
    ...
    #[IsGranted('ROLE_USER')]
    #[Route('/mon-profil/modifier', name:'app_profilUpdate')]//modifie user connecté
    ...
    {
        $form= $this->createForm(SignInType::class, $this->getUser());
